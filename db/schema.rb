...
ActiveRecord::Schema[8.1].define(version: 2026_05_14_092932) do
  ...
  create_table "agents", force: :cascade do |t|
    ...
    t.check_constraint "level BETWEEN 1 AND 10", name: "level_range_check"
  end
  ...
  create_table "missions", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('assigned', 'in_progress', 'completed')", name: "status_check"
  end
